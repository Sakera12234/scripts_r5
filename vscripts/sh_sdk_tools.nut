...
void function Precache_Sdk_Models()
{
	...
	PrecacheModel( $"mdl/techart/mshop/characters/legends/seer/seer_base_w.rmdl" )
	PrecacheModel( $"mdl/techart/mshop/characters/legends/seer/seer_base_v.rmdl" )
...
void function BecomeSeer(entity player)
{
	if(!IsValid(player))
		return

	player.SetBodyModelOverride($"mdl/techart/mshop/characters/legends/seer/seer_base_w.rmdl" )
	player.SetArmsModelOverride($"mdl/techart/mshop/characters/legends/seer/seer_base_v.rmdl" )
}
